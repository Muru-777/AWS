...
sudo kubeadm init --apiserver-advertise-address=${PUBLIC_IP_ADDRESS} --pod-network-cidr=10.244.0.0/16 --ignore-preflight-errors=NumCPU  --ignore-preflight-errors=Mem
sudo sleep 10
mkdir -p $HOME/.kube
